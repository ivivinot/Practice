...
url_1 = "https://careers.nus.edu.sg/NUS/go/Academic-and-Research-Positions/545744/"
url_2 = "https://careers.nus.edu.sg/NUS/go/Academic-and-Research-Positions/545744/25"
url_3 = "https://careers.nus.edu.sg/NUS/go/Academic-and-Research-Positions/545744/50"
...
def collect_jobtitles(url):
    ...
    if response.status_code == 200:
        ...
        job_org_elements = soup.find_all('td', class_="colShifttype hidden-phone")
        ...
        for element in job_URL_elements:
            ...
            for job_link in job_links:
                job_URL.append("https://careers.nus.edu.sg"+ job_link.get('href'))
...
#for index,joburl in enumerate(all_jobURL, start = 1):
...
excel_file = "NUS joblisting" + today + ".xlsx"
